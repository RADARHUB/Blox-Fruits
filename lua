...
if game.CoreGui.RobloxGui:FindFirstChild("Voice Chat Ui") then game.CoreGui.RobloxGui:FindFirstChild("Voice Chat Ui"):Destroy() end
	...
	function library:Window(name,game)
        if getgenv().Theme ~= nil then
            ...
            ColorIIII = Color3.fromRGB(0, 255, 0)
        
            ColorIIIII = Color3.fromRGB(0, 255, 0)
            ColorIIIIII = Color3.fromRGB(0, 255, 0)
        
            ColorIIIIIII = Color3.fromRGB(0, 255, 0)
            ColorIIIIIIII = Color3.fromRGB(0, 255, 0)
        end
        ...
        Main.Size = UDim2.new(0.00001, 675, 0, 395)
        ...
        TopMain.Parent = Main
        TopMain.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
        TopMain.Size = UDim2.new(0, 675, 0, 30)
        ...
        TopMainLine.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
        ...
        NameHub.Position = UDim2.new(0.0125000002, 0, 0.05, 0)
        ...
        Toggleui.Position = UDim2.new(0.17076923, 0, 0, 0)
        ...
        HideTab.ZIndex = 2
        HideTab.Image = "rbxassetid://8761358974"
        ...
        function Tabs:Tab(text)
            ...
            MainSection.ImageColor3 = Color3.fromRGB(18, 18, 18)
            ...
            SectionBorder.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            SectionTitle.BorderColor3 = Color3.fromRGB(0, 255, 0)
            ...
            SectionContent.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
        ...
        Tab.MouseButton1Click:Connect(function()
			...
			function TabElements:Button(text,callback)
				...
				ButtonRounded.ImageColor3 = Color3.fromRGB(0, 255, 0)
            ...
            function TabElements:Line()
                ...
                ButtonRounded.Selectable = true
                ButtonRounded.Size = UDim2.new(1, 0, 0.3, 0)
                ButtonRounded.ZIndex = 4
                ButtonRounded.Image = "rbxassetid://3570695787"
                ButtonRounded.ScaleType = Enum.ScaleType.Slice
                ButtonRounded.SliceCenter = Rect.new(100, 100, 100, 100)
                ButtonRounded.SliceScale = 0.001
            ...
            Welcome = function()
                    ...
                    " "
                        ..
                                ...
                                Gamename.. "]" .. "\n Welcome RADAR HUB"  .."  Succeed Thank you"
                    )
            end
        }
        }
...
spawn(function()
	game:GetService("RunService").Heartbeat:connect(function()
		if farm and StartMagnetAutoFarmLevel then
			CheckQuest()
			for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
				if v.Name == Ms and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
					if v.Name == "Factory Staff [Lv. 800]" or v.Name == "Dragon Crew Warrior [Lv. 1575]" or v.Name == "Dragon Crew Archer [Lv. 1600]" and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 250 then
                        if HideHitBlox then
                            v.HumanoidRootPart.Transparency = 1
                        else
                            v.HumanoidRootPart.Transparency = 50
                        end
					...
					elseif v.Name == Ms and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 250 then
                        if HideHitBlox then
                            v.HumanoidRootPart.Transparency = 1
                        else
                            v.HumanoidRootPart.Transparency = 50
...
spawn(function()
    pcall(function()
        while task.wait() do
            if Auto_Farm or KillPlayer or AutoNew or Autothird or Factory or NextIsland or TweenIsland then
...
spawn(function()
    while game:GetService("RunService").Stepped:wait(10) do
        ...
        if _G.NoClip or Auto_Farm or KillPlayer or AutoNew or Autothird or Factory or NextIsland or TweenIsland then
            pcall(function()
                    ...
                    spawn(function()
                        game:GetService("RunService").Heartbeat:Connect(function()
                            if fastattect then
                                ...
                                v2.activeController.timeToNextAttack = -(math.huge^math.huge^math.huge)
                                v2.activeController.timeToNextBlock = 0
                                v2.activeController.hitboxMagnitude = 45
                            end
                        end)
                    end)
                end
...
spawn(function()
    for i,v in pairs(getgc()) do
        if typeof(v) == "function" and getfenv(v).script == game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework.RigController then
            for i2,v2 in pairs(debug.getupvalues(v)) do
                if typeof(v2) == "table" then
                    spawn(function()
                    end)
...
local Main = library:Window("RADAR","")

local AutoFarmTab = Main:Tab("Auto Farm")

Time = AutoFarmTab:Label("Server Time")
...
AutoFarmTab:Toggle("Auto Farm Level", _G.AutoFarm,function(a)
    Auto_Farm = a
...
if NewWorld then
    ...
    AutoFarmTab:Toggle("Auto Factory", false,function(vu)
        Factory = vu
    end)
end
        ...
        if Superhuman and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then 
            ...
            if game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 300  then
                if game.Players.LocalPlayer.Data.Level.Value >= 1100 then
                    if Superhuman and game.Players.LocalPlayer.Data.Fragments.Value < 1500 then
                        RaidsSelected = "Flame"
                        AutoRaids = true
                        RaidsArua = true
                    else
...
AutoFarmTab:Toggle("Auto Buy Color Haki", false,function(Value)
    Enhancement = Value    
end)
spawn(function()
    while wait() do
...
AutoFarmTab:Line()
AutoFarmTab:Label("Auto Farm Level Lock")
LockLevelValue = 2200
OldLevel = game.Players.localPlayer.Data.Level.Value
AutoFarmTab:Slider("Select Level Lock",1,2200,LockLevelValue,nil,function(value)
    LockLevelValue = value
end)
AutoFarmTab:Toggle("Lock Level",locklevel,function(value)
    LockLevel = value
end)
spawn(function()
    while wait(.1) do
...
StatsTab:Toggle("Kaitan",false,function(value)
    Kaitan = value    
end)
...
spawn(function()
    while task.wait() do
        if game.Players.localPlayer.Data.Points.Value >= PointStats then
            if Kaitan and game.LocalPlayer.Data.Level.Value >= 767 then
                local args = {
                    [1] = "AddPoint",
                    [2] = "Defense",
                    [3] = PointStats
...
----------------------------------------------------------------------------------------------------------------------------
local PlayerEspTab = Main:Tab("Players")

PlayerServer = PlayerEspTab:Label("Players : "..game.Players.NumPlayers .. "/"..game.Players.MaxPlayers)
Fruit = PlayerEspTab:Label("Fruit : 0")
Chest = PlayerEspTab:Label("Chest : 0")
spawn(function()
    while wait() do
        local count10 = 0
        local count = 0
...
PlayerEspTab:Toggle("Kill Player",false,function(bool)
    ...
    EquipWeapon(SelectedKillPlayer)				   
    ...
    while KillPlayer do wait()
        totarget(game.Players:FindFirstChild(SelectedKillPlayer).Character.HumanoidRootPart.CFrame * CFrame.new(0,37,0))
...
local SelectToolWeaponGun = PlayerEspTab:Dropdown("SelectToolWeaponGun",Weapon,0,function(a)
    SelectToolWeaponGun = a 
end)

PlayerEspTab:Button("Refrash Weapon", function()
    Weapon = {}
    for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
        if v:IsA("Tool") then
            table.insert(Weapon ,v.Name)
    ...
    SelectToolWeaponGun:Refresh(Weapon,0)
end)
PlayerEspTab:Line()
...
spawn(function()
    while task.wait() do
        if KillPlayer then
            if game.Players:FindFirstChild(SelectedKillPlayer) and (game.Players:FindFirstChild(SelectedKillPlayer).Character.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude >= 0 then
            ...
            elseif game.Players:FindFirstChild(SelectedKillPlayer) and (game.Players:FindFirstChild(SelectedKillPlayer).Character.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude >= 0 then
                game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 30, 3)
                    ...
                    if string.find(v.Name,"Chest") then
                        if not v:FindFirstChild('NameEsp'..Number) then
                            ...
                            if v.Name == "Chest1" then
                                name.TextColor3 = Color3.fromRGB(165, 165, 165)
                                name.Text = ("Chest 1" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' M')
                            end
                            if v.Name == "Chest2" then
                                name.TextColor3 = Color3.fromRGB(221, 229, 72)
                                name.Text = ("Chest 2" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' M')
                            end
                            if v.Name == "Chest3" then
                                name.TextColor3 = Color3.fromRGB(79, 234, 234)
                                name.Text = ("Chest 3" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' M')
                            end
                        else
...
TeleportTab:Button("Teleport OldWorld" ,function()
    local args = {
...
TeleportTab:Button("Teleport NewWorld" ,function()
    local args = {
...
TeleportTab:Button("Teleport ThreeWorld" ,function()
    local args = {
        [1] = "TravelZou" -- OLD WORLD to NEW WORLD
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
ShopTab:Button("Random Race 3k Fragments",function()
    local args = {
        [1] = "BlackbeardReward",
        [2] = "Reroll",
        [3] = "2"
...
ShopTab:Button("Reset Stats 2.5K Fragments",function()
    local args = {
        [1] = "BlackbeardReward",
        [2] = "Refund",
        [3] = "2"
...
ShopTab:Button("Buy Skyjump",function()
    local args = {
        [1] = "BuyHaki",
        [2] = "Geppo"
    }
...
ShopTab:Button("Buy Buso Haki",function()
    local args = {
        [1] = "BuyHaki",
        [2] = "Buso"
    }
...
ShopTab:Button("Buy Soru",function()
    local args = {
        [1] = "BuyHaki",
        [2] = "Soru"
    }
...
ShopTab:Button("Buy Observation haki",function()
    local args = {
        [1] = "KenTalk",
        [2] = "Buy"
    }
...
ShopTab:Button("Random Devil Fruit",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
end)

ShopTab:Line()
ShopTab:Label("Buy Fighting Style",true)
...
spawn(function()
    while wait() do
        if Awakener and (game:GetService("Workspace")["_WorldOrigin"].Locations["l'Ãƒâ€°glise de ProphÃƒÂ©tie"].Position - game.Players.localPlayer.Character.HumanoidRootPart.Position).magnitude <= 100 then
...
RaidsTab:Button("Dungeon Room",function()
    if NewWorld then
...
RaidsTab:Button("Awakening Room",function()
    if NewWorld then
        if StatsBypassTP == "Bypassed" and UseTP then
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["_WorldOrigin"].Locations["l'Ãƒâ€°glise de ProphÃƒÂ©tie"].CFrame
        else
...
MiscTab:Toggle("Inf Look Far",false,function(Value)
...
MiscTab:Toggle("Infinits Ability",infAbility,function(value)
    infAbility = value
if infAbility then
...
MiscTab:Toggle("Infinits Soru",false,function(Value)
    Sorunocool = Value
    NoSoruCool()
end)
...
spawn(function()
    while game:GetService("RunService").Stepped:wait(10) do
        character = game.Players.LocalPlayer.Character 
        if _G.NoClip or Auto_Farm or AutoNew or Autothird or Factory then
            pcall(function()
                for _, v in pairs(character:GetDescendants()) do
                    pcall(function()
                        if v:IsA("BasePart") then
...
MiscTab:Toggle("Auto Observation haki", false,function(Value)
    AUTOHAKIObs = Value  
end)
AUTOHAKI = true
MiscTab:Toggle("Auto Haki", AUTOHAKI,function(Value)
    AUTOHAKI = Value  
end)
...
MiscTab:Button("Max Zoom",function()
    while wait() do
...
Server_Hop_LessPeople = SettingTab:Button("Hop Less People",function()
    local PlaceID = game.PlaceId
    local AllIDs = {}
    local foundAnything = ""
    local actualHour = os.date("!*t").hour
...
SettingTab:Line()
SettingTab:Label("Auto Farm Mastery Skill Setting",true)

SettingTab:Toggle("Skill Z", true,function(a)
    SkillZ = a
end)
SettingTab:Toggle("Skill X", true,function(a)
    SkillX = a
end)
SettingTab:Toggle("Skill C", true,function(a)
    SkillC = a
end)
SettingTab:Toggle("Skill V", true,function(a)
    SkillV = a
end)
